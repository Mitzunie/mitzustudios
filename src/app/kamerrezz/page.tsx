...
import { Code2, GraduationCap, Users, Github, ExternalLink, ArrowLeft } from 'lucide-react'
...
const featureIcons = [Code2, GraduationCap, Users, Github]

export default function KamerrezzPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen pt-16">
        <section className="neo-border py-24">
          <div className="container-custom mx-auto px-4">
            ...
            <SectionAnimation animation="fadeIn" threshold={0.2}>
              <div className="neo-border bg-card mx-auto mb-24 max-w-3xl p-8 text-center">
                <p className="text-foreground mb-6 text-lg font-bold leading-relaxed uppercase tracking-wide">
                  {t.zeewCta}
                </p>
                <a
                  ...
                  className="neo-button neo-button-primary neo-shadow-sm inline-flex items-center gap-2 px-8 py-3 text-base font-bold uppercase tracking-wide"
                >
